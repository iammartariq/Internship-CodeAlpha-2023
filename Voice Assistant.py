...
def listen():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print("Sorry, Can you please repeat? I couldn't understand that.")
...
def handle_query(query):
    ...
    if 'hello' in query or 'hi' in query or 'hey' in query:
        ...
        print("I am good, thankyou for asking!! How are you?")
        ...
        print(f"Here are results for {query.strip()}, i hope that will help you out")

    elif "stop" in query or "end" in query or "finish" in query:

        speak("Goodnbye! Have a nice day!!")
